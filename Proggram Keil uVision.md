...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, TRIGGER_Pin|LED_Pin|PUMP_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : TRIGGER_Pin LED_Pin PUMP_Pin */
  GPIO_InitStruct.Pin = TRIGGER_Pin|LED_Pin|PUMP_Pin;
